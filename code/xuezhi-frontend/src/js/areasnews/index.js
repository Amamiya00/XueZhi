...
class AreasNews extends Component {
    ...
    _net(page) {
        ...
        const url = "http://localhost:8085/v1/qa_service/qa/questions/"+school+"/"+area;
        console.log(url)
        ...
        if(!this.state.isNull){
            return (
                <div>
                    ...
                    <div className="g-container areasnews">
